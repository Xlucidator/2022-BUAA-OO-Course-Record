...
public class ElevatorThread extends Thread {
    ...
    public ElevatorThread(int id, String type) {
        ...
        this.switchInfo = type.equals("floor") ? 31 : 0;

        char buildNo = type.equals("floor") ? 'A' : (char)(id + 64);
        this.elevator = new Elevator(id, this.type, buildNo, 1, 8, 0.6, 31);
    }
    ...
    public ElevatorThread(int id, String type, char buildNo, int floorNo,
        ...
        this.elevator = new Elevator(id, this.type, buildNo, floorNo, capacity, speed, switchInfo);
    }
