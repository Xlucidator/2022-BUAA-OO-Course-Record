...
public class Main {
    public static void main(String[] args) {
        ...
        /* ======= TransferCounter Linked ======*/
        TransferCounter.getInstance().initial(waitQueue);
        ...
        for (int i = 1; i <= 15; ++i) {
            ...
            if (i <= 5) {
                ...
                elevators.addElevator(new ElevatorThread(i, "floor"));
            }
        ...
        ScheduleThread.getInstance().initial(waitQueue, processQueues, elevatorQueues);
        ScheduleThread.getInstance().start(); // START
    }
}
